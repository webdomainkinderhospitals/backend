...
BEGIN
  ...
  IF to_regclass('"Location"') IS NOT NULL THEN
    ...
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "kind" TEXT NOT NULL DEFAULT 'hospital';
    ...
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "promo2ImageUrl" TEXT NOT NULL DEFAULT '';
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "promo2Link" TEXT NOT NULL DEFAULT '';
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "promo2Alt" TEXT NOT NULL DEFAULT '';
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "promo3ImageUrl" TEXT NOT NULL DEFAULT '';
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "promo3Link" TEXT NOT NULL DEFAULT '';
    ALTER TABLE "Location" ADD COLUMN IF NOT EXISTS "promo3Alt" TEXT NOT NULL DEFAULT '';
  END IF;
